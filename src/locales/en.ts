...
export const en = {
  ...
  tasks: {
    ...
    archived: {
        ...
        view_archived_items: 'View Archive',
        manager_desc: 'Manage archived items for {{name}}',
        manager_desc_global: 'Manage all archived items in the system.',
        archived_tasks_title: 'Archived Tasks',
        archived_boards_title: 'Archived Boards',
        ...
        restore_task_title: 'Restore Task',
        restore_task_desc: 'To which list should the task "{{task}}" be restored?',
        select_list_for_restore: 'Select a list for restore',
        restore_list_title: 'Restore List',
        restore_list_desc: 'The list "{{list}}" is being restored.',
        restore_list_tasks_prompt: 'Do you want to restore the archived tasks from this list as well?',
        no_archived_tasks_in_list: 'There are no archived tasks in this list.',
    },
    priority: {
        low: 'Low',
        medium: 'Medium',
    ...
    dialog: {
        ...
        configure_report_title: 'Configure Email Report',
        edit_report_title: 'Edit Email Report',
        ...
        report_intro_label: 'Introduction Text (Optional)',
        report_intro_placeholder: 'Add an optional message to the email body...',
        report_no_intro_text: 'No introduction text.',
        report_preview_title: 'Email Preview',
        report_preview_subject: 'Subject',
        report_preview_to: 'To',
    ...
    report_types: {
        'weekly-my-tasks': 'My Weekly Tasks',
        'weekly-all-tasks': 'All Weekly Tasks',
        'weekly-overdue': 'Weekly Overdue Tasks',
        'weekly-due-soon': 'Weekly Tasks Due Soon',
        weekly: 'Weekly',
    },
    tooltips: {
        attachments_count: '{{count}} attachment(s)',
    ...
    toast: {
        ...
        no_active_board_for_restore: 'No active boards to restore to. Please unarchive or create a board first.',
        no_active_columns_for_restore: 'The destination board has no active lists to restore the task to.',
        ...
        comment_added_title: 'Comment Added',
        comment_added_desc: 'Your comment has been successfully posted.',
        comment_deleted_title: 'Comment Deleted',
        ...
        mic_error: 'Could not access the microphone. Please check permissions.',
    },
    comment_shortcut_hint: 'Submit with Enter, new line with Shift+Enter',
    column_titles: {
        todo: 'To Do',
